    ...
    <div className="bg-white">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mb-2">
          ...
          <span className="ml-1 text-gray-600">{product.rating.toFixed(2)}</span>
        </div>
        <div className="flex items-baseline mb-2">
          <span className="text-xl font-bold text-green-600">${Math.round(product.price*(1-product.discountPercentage/100))}</span>
